...
int main(int argc, char **argv)
{
  ...
  if( !subscribeDepth ){      
      ...
      ros::Subscriber camera_info_sub = nh_.subscribe("/camera/rgb/camera_info", 1, cameraInfoCallback);
      ...
      // rgbd
      message_filters::Subscriber<sensor_msgs::Image> rgb_image_sub(nh_,"/camera/rgb/image_raw",3);
      message_filters::Subscriber<sensor_msgs::Image> depth_sub(nh_,"/camera/depth_registered/image_raw",3);            
      ...
      depth_info_sub = nh_.subscribe("/camera/depth_registered/camera_info",1 , depthInfoCallback);
